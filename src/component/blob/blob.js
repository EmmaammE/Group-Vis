...
class Blobs extends React.Component {
  ...
  render() {
    ...
    return (
      <svg 
        className="venn" height="200px" width="100%" 
        viewBox={`0 0 ${2 * BOX_WIDTH} ${100+ BOX_WIDTH}`} xmlns="http://www.w3.org/2000/svg"
      >
        <foreignObject x="0" y="-80" width="100%" height="100%" ref={this.$venn}>
        </foreignObject>
      </svg>
    );
  }
